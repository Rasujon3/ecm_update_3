...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Size Measurement</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{URL::to('/dashboard')}}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{URL::to('/size-measurement')}}">Size Measurement
                                </a></li>
    ...
    <section class="content">
        ...
        <div class="card card-success">
            <div class="card-header">
                <h3 class="card-title">Size Measurement</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('size-measurement.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    class="dropify"
                                    data-height="150"
                                    data-default-file="{{ ($data && $data->img) ? URL::to($data->img ?: '') : '' }}"
                                />
                                @error('img')
